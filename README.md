...
- ✅ Setup takes only a few minutes ([single file config](https://github.com/Derekstewart6666/nextjs-notion-blog-starter/blob/main/data/siteData.ts)) 💪
- ✅ Newsletter subscription via [Convertkit API](https://github.com/Derekstewart6666/nextjs-notion-blog-starter/blob/main/pages/api/subscribe-convertkit.tsx)
- ✅ Simple analytics with [Umami](https://github.com/umami-software/umami)

- ✅ Automatic OG social images with [Tailwind template](https://github.com/Derekstewart6666/nextjs-notion-blog-starter/blob/main/components/OgTemplate.tsx)
...
- `pages/api/*` - [API routes](https://nextjs.org/docs/api-routes/introduction) powering [`/og-image`](https://github.com/neg4n/next-api-og-image) dynamic OG image and [`/subscribe-convertkit`](https://github.com/Derekstewart6666/nextjs-notion-blog-starter/blob/main/pages/api/subscribe-convertkit.tsx) newsletter subscription.
...
```bash
git clone https://github.com/Derekstewart6666/nextjs-notion-blog-starter
